...
void MultiOtoAudioProcessorEditor::resized() {
    ...
    auto layoutStage = [&](juce::GroupComponent& group, bool open, ArcKnob& gH, ArcKnob& gM, ArcKnob& gL, ArcKnob& dH, ArcKnob& dM, ArcKnob& dL, ArcKnob& time, ArcKnob& aH, ArcKnob& aM, ArcKnob& aL, ArcKnob& rH, ArcKnob& rM, ArcKnob& rL, juce::TextButton& btn, juce::Rectangle<int> bounds) {
